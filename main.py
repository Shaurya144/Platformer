...
pygame.display.set_caption('Jumpy By Shaurya')
clock = pygame.time.Clock()
FPS = 60

pygame.mixer.music.load("assets/assets_music.mp3")
...
while run:
    ...
    if not game_over:
        ...
        if fade_counter < SCREEN_WIDTH // 2:
            fade_counter += 5
            pygame.draw.rect(screen, OTHER_COLOR, (0, 0, fade_counter, SCREEN_HEIGHT))
            pygame.draw.rect(screen, OTHER_COLOR, (SCREEN_WIDTH - fade_counter, 0, SCREEN_WIDTH, SCREEN_HEIGHT))
        else:
